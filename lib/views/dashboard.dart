...
class DashboardScreen extends StatefulWidget {
 ...
 final double totalBalance;
  const DashboardScreen({
    super.key,
    required this.transactions, required  this.totalBalance, required Future<void> Function() onTransactionsUpdated,
  });
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalIncome = utilService.calculateBalance(widget.transactions, Constants.transactionType[0]);
    final totalExpenses =utilService.calculateBalance(widget.transactions, Constants.transactionType[1]);
                      ...
                      Expanded(
                        child: widget.transactions.isEmpty
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final sortedTransactions = List.from(widget.transactions)
                            ...
                            return ListTile(
                              ...
                              title: Text(txn.category!='Other'?txn.category:txn.customCategory,style: TextStyle(fontSize: 12),),
                              subtitle: Text(
                                  indianRupeeFormat.format(txn.amount), style: TextStyle(fontSize: 14),),
                              trailing: Text(
